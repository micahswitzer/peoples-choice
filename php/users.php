...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $result = execute_sql('SELECT id, first_name, last_name, student as is_student, admin as is_admin FROM mzpc_user WHERE section_id = ?', [$_GET['section']])->fetchAll(PDO::FETCH_GROUP|PDO::FETCH_ASSOC);

...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    if (isset($put['pass']))
        execute_sql('UPDATE mzpc_user SET pass = ? WHERE id = ?', [password_hash($put['pass']), $_GET['id']]);
    if ($edit_self) {
        execute_sql(
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    execute_sql(
        ...
        [$_POST['first_name'], $_POST['last_name'], password_hash('password'), $_POST['student'], $_POST['admin'], $_POST['section_id']]);
}
